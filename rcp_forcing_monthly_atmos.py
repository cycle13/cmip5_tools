...
# Bias-correct the RCP monthly atmospheric forcing from ACCESS1-0 and the 
...
# RCP files for ACCESS1-0 and MMM as follows:
# mkdir rcp45_monthly; cp rcp45_raw/ACCESS1-0.nc rcp45_raw/MMM.nc rcp45_monthly/
# mkdir rcp85_monthly; cp rcp85_raw/ACCESS1-0.nc rcp85_raw/MMM.nc rcp85_monthly/
            ...
            for expt in expt_names:
                ...
                for year in range(start_year, end_year+1):
                    ...
                    if var == 'tcc':
                        ...
                        # Maybe I should not have done this because condensation is here too?!
                        #index = model_rcp > 0
                        #model_rcp[index] = 0.0
